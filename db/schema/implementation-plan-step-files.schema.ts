...
export type ImplementationPlanStepFile =
  typeof implementationPlanStepFiles.$inferSelect;
export type NewImplementationPlanStepFile =
  typeof implementationPlanStepFiles.$inferInsert;
