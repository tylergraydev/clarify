 ...
 */
export const DEFAULT_TOOLS_BY_AGENT_TYPE: Record<AgentToolType, ReadonlyArray<BuiltinToolName>> = {
 ...
 */
export function getDefaultToolsForAgentType(type: AgentToolType): ReadonlyArray<BuiltinToolName> {
