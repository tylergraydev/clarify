...
export type TemplatePlaceholderFormValues = z.infer<typeof templatePlaceholderSchema>;
...
export const createTemplateSchema = z.object({
  ...
  templateText: z.string().min(1, 'Template text is required').max(50000, 'Template text is too long'),
});
...
export type TemplateWithPlaceholdersFormValues = z.infer<typeof templateWithPlaceholdersSchema>;
...
export type UpdateTemplateWithPlaceholdersFormValues = z.infer<typeof updateTemplateWithPlaceholdersSchema>;
