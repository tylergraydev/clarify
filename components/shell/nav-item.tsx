...
interface NavItemProps extends NavItemVariants, Omit<ComponentPropsWithRef<typeof Link>, 'children'> {
  href: string;
  icon?: ElementType;
  isActive?: boolean;
  isCollapsed?: boolean;
...
export const NavItem = ({
  ...
  const linkContent = (
    ...
    >
      {/* Icon */}
      {Icon && <Icon aria-hidden={'true'} className={cn('size-4 shrink-0', isActive && 'text-accent-foreground')} />}
