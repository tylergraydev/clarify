...
export const ChainOfThoughtSearchResult = memo(({ children, className, ...props }: ChainOfThoughtSearchResultProps) => (
  <Badge className={cn('gap-1 px-2 py-0.5 text-xs font-normal', className)} variant={'default'} {...props}>
    {children}
  </Badge>
));
  ...
  return (
    <Collapsible open={isOpen}>
      <CollapsibleContent
        className={cn(
          'mt-2 space-y-3',
          'text-accent-foreground outline-none data-closed:animate-out',
          'data-closed:fade-out-0 data-closed:slide-out-to-top-2',
