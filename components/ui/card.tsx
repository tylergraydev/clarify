...
export const Card = ({ className, ref, ...props }: CardProps) => {
  return (
    <div className={cn('rounded-lg border border-card-border bg-card shadow-sm', className)} ref={ref} {...props} />
  );
};
...
export const CardTitle = ({ className, ref, ...props }: CardTitleProps) => {
  return <h3 className={cn('text-lg leading-none font-semibold tracking-tight', className)} ref={ref} {...props} />;
};
