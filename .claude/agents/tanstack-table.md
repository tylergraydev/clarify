...
color: red
tools: Read(*), Write(*), Edit(*), Glob(*), Grep(*), Bash(bun lint), Bash(bun typecheck), Skill(tanstack-table), Skill(component-conventions), Skill(react-coding-conventions), Skill(tanstack-query-conventions)
---
