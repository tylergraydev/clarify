...
color: cyan
allowed-tools: Read(*), Write(*), Edit(*), Glob(*), Grep(*), Bash(pnpm lint), Bash(pnpm typecheck), Skill(component-conventions), Skill(react-coding-conventions), mcp__base-ui__base_ui_list_docs, mcp__base-ui__base_ui_get_doc
---
