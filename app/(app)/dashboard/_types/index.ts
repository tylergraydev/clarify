 ...
 */
export type WorkflowDurationData = Pick<Workflow, 'completedAt' | 'durationMs' | 'startedAt' | 'status'>;
 ...
 */
export type WorkflowStatusBadgeVariant = 'clarifying' | 'completed' | 'default' | 'failed' | 'planning';
