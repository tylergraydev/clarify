...
import { Bot, Code, GitBranch, ListTodo, MessageSquare, Search, Shield, Sparkles } from 'lucide-react';
...
interface PipelineStepNodeProps
  extends Omit<ComponentPropsWithRef<'div'>, 'children'>, VariantProps<typeof pipelineStepNodeVariants> {
  children?: ReactNode;
...
export const PipelineStepNode = ({
  ...
  return (
    <div className={cn(pipelineStepNodeVariants({ className, state: resolvedState }))} ref={ref} {...props}>
        ...
        >
          ...
          <span
            className={cn(
              ...
              isActive ? 'bg-purple-500/20 text-purple-700 dark:text-purple-400' : 'bg-muted text-muted-foreground'
            )}
          >
            {stepNumber}
          </span>
