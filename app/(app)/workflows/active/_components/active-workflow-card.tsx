...
interface ActiveWorkflowCardProps extends Omit<ComponentPropsWithRef<'div'>, 'onClick'> {
 ...
 */
const WorkflowTypeIcon = ({ className, type }: { className?: string; type: string }) => {
  ...
  return (
    ...
    >
        ...
        <div className={'flex items-start justify-between gap-2'}>
          <div className={'flex min-w-0 flex-1 items-start gap-2'}>
            ...
            <div className={'min-w-0 flex-1'}>
              ...
              {projectName && <p className={'line-clamp-1 text-sm text-muted-foreground'}>{projectName}</p>}
            </div>
          </div>
              ...
              {workflow.currentStepNumber && workflow.totalSteps && (
                <Fragment>
                  ...
                  <span
                    ...
                    title={currentStepName ?? getStepLabel(workflow.currentStepNumber)}
                  >
      ...
      <CardFooter className={'flex-wrap gap-2'}>
        {/* View Button */}
        <Button aria-label={'View workflow details'} onClick={handleViewClick} size={'sm'} variant={'outline'}>
