...
function WorkflowHistoryPageContent() {
  ...
  // Data fetching
  const { data: historyResult, isLoading: isLoadingHistory } =
    useWorkflowHistory(historyFilters);
    ...
    <div className={"space-y-6"}>
      ...
      <QueryErrorBoundary>
        {isLoading ? (
          ...
          <EmptyState
            description={
              "Completed workflows will appear here. Start a new workflow to build your history."
            }
